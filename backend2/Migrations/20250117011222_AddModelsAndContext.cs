...
{
    /// <inheritdoc />
    public partial class AddModelsAndContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserIdReferrer = table.Column<int>(type: "int", nullable: false),
                    EmailRef = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NameRef = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReferringUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
